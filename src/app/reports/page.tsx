                  ...
                  >
                    ...
                    <div className="shrink-0 border-t border-black border-dashed pt-1.5 text-[13px]">
                      <div className="flex justify-between items-stretch">
                        ...
                        <div className="w-56 text-[13px] leading-snug">
                          {receiptData.paymentStatus === 'DP' ? (
                            <>
                              ...
                              <div className="flex justify-between font-bold border-t border-black border-dashed pt-0.5 text-red-600">
                            ...
                            <>
                              ...
                              <div className="text-right text-[11px] font-bold text-green-700 uppercase mt-0.5">
                                [ LUNAS ]
                              </div>
                            </>
                          )}
