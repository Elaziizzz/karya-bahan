...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-transparent absolute inset-0 z-50 overflow-hidden">
      {/* 3D Interactive Background */}
      <iframe src="/galaxy.html" className="absolute inset-0 w-full h-full border-none -z-10" title="Interactive Background" />
