...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <nav className="print:hidden md:hidden fixed bottom-0 w-full bg-white border-t-2 border-black z-50 flex justify-around items-center p-2 pb-safe shadow-[0_-4px_0_0_rgba(0,0,0,0.1)]">
