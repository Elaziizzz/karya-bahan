...
content = content.replace(/<div className="bg-gray-100 p-4 border-t-2 border-black">\s*<div className="flex justify-between items-center mb-4">/g, newCheckoutUI);

fs.writeFileSync("src/app/page.tsx", content);
console.log("Injected UI for DP and Customer using Regex.");
